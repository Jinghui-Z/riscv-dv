...
// Section 7.4 - Vector Mask and Whole-Register Unit-Stride Instructions
`DEFINE_VA_INSTR(VLM_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VSM_V, VS_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VL1RE8_V,  VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL1RE16_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL1RE32_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL1RE64_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL2RE8_V,  VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL2RE16_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL2RE32_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL2RE64_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL4RE8_V,  VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL4RE16_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL4RE32_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL4RE64_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL8RE8_V,  VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL8RE16_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL8RE32_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VL8RE64_V, VL_FORMAT, LOAD, RVV)
`DEFINE_VA_INSTR(VS1R_V, VS_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VS2R_V, VS_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VS4R_V, VS_FORMAT, STORE, RVV)
`DEFINE_VA_INSTR(VS8R_V, VS_FORMAT, STORE, RVV)
